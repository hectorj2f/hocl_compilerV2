...
public class RunSampleChService1_gen {
	...
	public static Molecule addElement(String line, Solution sol) throws Exception{
		Molecule mol = new Molecule();
					if (line.equals("put") || line.equals("p")) {
						...
						mol = ((SampleChService1_gen)sol).addElementSubSolution(line);					}
		return mol;
	}
	...
	public static void main(String args[]) throws Exception{
		...
		Hocli.init(args);
		Solution sol = new SampleChService1_gen();
			...
			try{
				...
				if( line == null ) {
					...
					sol.removeAtomFromContainer(atom);
						...
						mo = ((SampleChService1_gen)sol).addInheritRemoveTuple(line);
						sol.addMolecule(mo);
						//sol.setNonInert();
						//sol.reduce();
					}
					...
					if (line.equals("quit") || line.equals("q"))
						...
						try {
							String name = "SampleChService1Srv";
							GeneralSrvInterface Server = new SampleChService1Srv(sol);
							Registry registry = LocateRegistry.getRegistry();
							registry.rebind(name, Server);
							name = "SampleChService1Clt";
							GeneralCltInterface Client = new SampleChService1Clt(sol);
							...
							while (out ==0){
								...
								String Comstr = new BufferedReader(new InputStreamReader(System.in)).readLine();
									...
									if (Comstr.equals("put")||Comstr.equals("p")||Comstr.equals("PUT")||Comstr.equals("p")){
										...
										Molecule m = ((SampleChService1_gen)sol).addElementSubSolution(Comstr);
										remoteiosrv.remoteOperations(m);
										System.out.println("The element "+m+" has been added into the remote multi-set.");
									}
									...
									if (Comstr.equals("get")||Comstr.equals("g")||Comstr.equals("GET")||Comstr.equals("G")){
										...
										Molecule m = ((SampleChService1_gen)sol).addRemoveTuple();
										remoteiosrv.remoteOperations(m);
									}

									else{
										Molecule m = ((SampleChService1_gen)sol).addInheritRemoveTuple(Comstr);
										remoteiosrv.remoteOperations(m);
									}
									...
									String ip=addr.getHostAddress();									remoteiosrv.remoteCheckState(ip, "SampleChService1Clt");
								}
						...
						System.out.println(((SampleChService1_gen) sol).displayTypes());
					}
								...
								if(file.renameTo(new File(dir, file.getName()))){
									if(deleteDir(ruledir)){
										try{
											...
											r.exec(compile);
											((SampleChService1_gen)sol).addType(ruleClassName);
